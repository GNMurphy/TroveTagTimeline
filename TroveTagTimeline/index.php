...
//        print_r($tagIndex);
    ...
    function tagCloud()
    {
        ...
        $headerToolTip = 'Word cloud showing all tags found in the search results. /nTags that are used in only 1 item are not shown initially; click the chevron to the left to show/hide theses tags';
